...
<form action="?<?php htmlout($action); ?>" method="post" onsubmit="return doublecheck();">

<div>
	<label for="name">Name: 
	<input type="text" name="name"
 id="nametext" value="<?php htmlout($name); ?>"/>
	</label>
...
<div>
	...
	<input type="submit" id="addbutton" value="<?php htmlout($button); ?>"/>
